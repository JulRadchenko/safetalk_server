...
def text_analysis(current_audio):
    ...
    if code_danger >= 1:
        risk_level = 'Высокий'
        title = '[size=18][color=ff0000][b]ВЫСОКИЙ РИСК МОШЕННИЧЕСТВА![/b][/color]'
        content = f'''{title}\n
[size=14][color=000000][b]Система распознала сценарий "Сообщите код".\nЧто делать прямо сейчас:[/b]
...
5. Перезвоните в ваш банк по официальному номеру, указанному на обороте карты.[/color][/size]'''
        ...
        title = '[size=18][color=ff0000][b]ВЫСОКИЙ РИСК МОШЕННИЧЕСТВА![/b][/color]'
        content = f'''{title}\n
[size=14][color=000000][b]Система распознала сценарий "Финансы под угрозой".\nЧто делать прямо сейчас:[/b]
1. [color=ff0000][b]НЕЗАМЕДЛИТЕЛЬНО[/b][/color] прекратите разговор и положите трубку.
2. [color=ff0000][b]НЕ[/b][/color] называйте никакие коды из SMS или push-уведомлений.
3. [color=ff0000][b]НЕ[/b][/color] переводите деньги на какие-либо счета.
4. Если вы [color=ff0000][b]УЖЕ СООБЩИЛИ[/b][/color] код - заблокируйте карту через мобильное приложение.
5. Перезвоните в ваш банк по официальному номеру, указанному на обороте карты.[/color][/size]'''
        ...
        title = '[size=18][color=ff0000][b]ВЫСОКИЙ РИСК МОШЕННИЧЕСТВА![/b][/color]'
        content = f'''{title}\n
[size=14][color=000000][b]Система распознала сценарий "Родственник в беде".\nЧто делать прямо сейчас:[/b]
...
4. Помните: сотрудник полиции/СК [color=ff0000][b]никогда не потребует[/b][/color] перевода денег для освобождения вашего родственника.[/size]'''

    elif bank_danger >= 1 or hack_danger >= 1:
        risk_level = 'Средний'
        title = '[size=18][color=ffd700][b]СРЕДНИЙ РИСК МОШЕННИЧЕСТВА![/b][/color]'
        content = f'''{title}\n
[size=14][color=000000][b]Рекомендации:[/b]
...
4. Прекратите разговор и перезвоните в банк самостоятельно по официальному номеру.[/size]'''

    else:
        risk_level = 'Низкий'
        title = '[color=008000][b][size=18]НИЗКИЙ РИСК МОШЕННИЧЕСТВА[/size][/b][/color]'
        content = f'''{title}\n
[size=14][color=000000][b]Правила безопасности при телефонном разговоре:[/b]
...
4. Помните: сотрудники банка никогда не запрашивают данные карты по телефону.[/size]'''
